					...
					<ul>
						<li class="accordion-item">
							...
							<div class="accordion-item-content">
								...
								<a href="/shopping-cart/" class="panel-close"><i
										class="fas fa-shopping-cart"></i>Shopping Cart</a>
								<a href="/all-categories/" class="panel-close"><i
										class="fas fa-layer-group"></i>Categories</a>
								<a href="/wishlist/" class="panel-close"><i class="fas fa-heart"></i>Wishlist</a>
								<a href="/checkout/" class="panel-close"><i
										class="fas fa-cart-arrow-down"></i>Checkout</a>
								<a href="/account-buyer/" class="panel-close"><i class="fas fa-user"></i>Account
									Buyer</a>
								<a href="/account-seller/" class="panel-close"><i class="fas fa-user"></i>Account
									Seller</a>
								<a href="/tracking-order/" class="panel-close"><i class="fas fa-truck"></i>Tracking
									Order</a>
								<a href="/order-history/" class="no-mb panel-close"><i
										class="fas fa-history"></i><span>Order History</span></a>
					...
					<div data-pagination='{"el": ".swiper-pagination"}' data-space-between="10"
						...
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<div class="content">
									<div class="mask"></div>
									<img src="<?=base_url('assets/themes/evone/');?>images/banner1.jfif" alt="">
								</div>
							</div>
							<div class="swiper-slide">
								<div class="content">
				...
				<div class="container">
					...
					<?php if ( count($categories) > 0) : ?>
                        <?php foreach ($categories as $category) : ?>
							<div class="col-20">
								<div class="content">
									<a href="<?php echo site_url('shop/products_in_category/'. $category->id .'/'. $category->name .'/'); ?>">
										<div class="icon">
											...
											<a href="<?php echo site_url('shop/product/'. $product->id .'/'. $product->sku .'/'); ?>">
												<div class="product-mark-discount">
													...
													<?php if ($product->current_discount > 0) : ?>
														<li><?php echo count_percent_discount($product->current_discount, $product->price, 0); ?>%</li>
														<li>OFF</li>
													<?php endif; ?>
													</ul>
												</div>
												...
												<div class="text">
												<?php if ($product->current_discount > 0) : ?>
													<p>Rp <?php echo format_rupiah($product->price - $product->current_discount); ?> <span>Rp <?php echo format_rupiah($product->price); ?></span></p>
													<?php else : ?>
														<p>Rp <?php echo format_rupiah($product->price); ?></p>
												<?php endif; ?>
												</div>
											</a>
										</div>
									...
									<div class="swiper-slide">
										<div class="content content-shadow-product">
											<a href="<?php echo site_url('shop/product/'. $product->id .'/'. $product->sku .'/'); ?>">
												<img src="<?php echo base_url('assets/uploads/products/'. $product->picture_name); ?>" alt="<?php echo $product->name; ?>">
												<div class="text">
													<p class="title-product"><?php echo $product->name; ?></p>
													<p class="price">Rp <?php echo format_rupiah($product->price - $product->current_discount); ?></p>
												</div>
											</a>
										</div>
									</div>
				...
				<div class="container">
						...
						<div data-pagination='{"el": ".swiper-pagination"}' data-space-between="10"
							...
							<div class="swiper-wrapper">
								<div class="swiper-slide">
									<div class="content">
										<div class="mask"></div>
										<img src="<?=base_url('assets/themes/evone/');?>images/banner4.png" alt="">
									</div>
								</div>
								<div class="swiper-slide">
									<div class="content">
										<div class="mask"></div>
										<img src="<?=base_url('assets/themes/evone/');?>images/banner5.png" alt="">
									</div>
								</div>
								<div class="swiper-slide">
									<div class="content">
										<div class="mask"></div>
										<img src="<?=base_url('assets/themes/evone/');?>images/banner6.png" alt="">
									</div>
								</div>
							</div>
						</div>
					...
					<div class="popular-brand segments-bottom">
						...
						<div class="row">
							<div class="col-25">
								<div class="content">
									<a href="#"><img src="<?=base_url('assets/themes/evone/');?>images/trip.png"
											alt=""></a>
								</div>
							</div>
							<div class="col-25">
								<div class="content">
									<a href="#"><img src="<?=base_url('assets/themes/evone/');?>images/wobag.png"
											alt=""></a>
								</div>
							</div>
							<div class="col-25">
								<div class="content">
									<a href="#"><img src="<?=base_url('assets/themes/evone/');?>images/john.png"
											alt=""></a>
								</div>
							</div>
							<div class="col-25">
								<div class="content">
									<a href="#"><img src="<?=base_url('assets/themes/evone/');?>images/alya.png"
											alt=""></a>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-25">
								<div class="content">
									<a href="#"><img src="<?=base_url('assets/themes/evone/');?>images/green.png"
											alt=""></a>
								</div>
							</div>
							<div class="col-25">
								<div class="content">
									<a href="#"><img src="<?=base_url('assets/themes/evone/');?>images/zona.png"
											alt=""></a>
								</div>
							</div>
							<div class="col-25">
								<div class="content">
									<a href="#"><img src="<?=base_url('assets/themes/evone/');?>images/beauty.png"
											alt=""></a>
								</div>
							</div>
							<div class="col-25">
								<div class="content">
									<a href="#"><img src="<?=base_url('assets/themes/evone/');?>images/fitbro.png"
											alt=""></a>
								</div>
							</div>
						</div>
							...
							<div class="col-50">
								<div class="content content-shadow-product">
									<a href="/product-details/">
										...
										<img src="<?=base_url('assets/themes/evone/');?>images/product1.jpg" alt="">
										<div class="text">
							...
							<div class="col-50">
								<div class="content content-shadow-product">
									<a href="/product-details/">
										...
										<img src="<?=base_url('assets/themes/evone/');?>images/product3.jpg" alt="">
										<div class="text">
							...
							<div class="col-50">
								<div class="content content-shadow-product">
									<a href="/product-details/">
										...
										<img src="<?=base_url('assets/themes/evone/');?>images/product5.jpg" alt="">
										<div class="text">
							...
							<div class="col-50">
								<div class="content content-shadow-product">
									<a href="/product-details/">
										...
										<img src="<?=base_url('assets/themes/evone/');?>images/product6.jpg" alt="">
										<div class="text">
							...
							<div class="col-50">
								<div class="content content-shadow-product">
									<a href="/product-details/">
										...
										<img src="<?=base_url('assets/themes/evone/');?>images/product9.jpg" alt="">
										<div class="text">
							...
							<div class="col-50">
								<div class="content content-shadow-product">
									<a href="/product-details/">
										...
										<img src="<?=base_url('assets/themes/evone/');?>images/product10.jpg" alt="">
										<div class="text">
			...
			<div class="cart segments">
				<div class="container">
					<div class="name-store">
						<img src="<?=base_url('assets/themes/evone/');?>images/user-seller1.png" alt="">
						...
						<div class="row">
							...
							<div class="col-90">
								<div class="content-cart content-shadow-product">
									<img src="<?=base_url('assets/themes/evone/');?>images/product8.jpg" alt="">
					...
					<div class="content">
						<div class="row">
							...
							<div class="col-90">
								<div class="content-cart content-shadow-product">
									<img src="<?=base_url('assets/themes/evone/');?>images/product12.jpg" alt="">
									<div class="product-info">
										<a href="#">
					...
					<div class="name-store">
						<img src="<?=base_url('assets/themes/evone/');?>images/user-seller2.png" alt="">
						<div class="title-store">
							<h6>Shirt Mart</h6>
						</div>
					</div>
					<div class="content">
						<div class="row">
							...
							<div class="col-90">
								<div class="content-cart content-shadow-product">
									<img src="<?=base_url('assets/themes/evone/');?>images/flash-sale1.jpg" alt="">
									<div class="product-info">
										<a href="#">
			...
			<div class="account-buyer segments">
				<div class="container">
					<div class="header-account content-shadow">
						<img src="<?=base_url('assets/themes/evone/');?>images/user-buyer6.png" alt="">
