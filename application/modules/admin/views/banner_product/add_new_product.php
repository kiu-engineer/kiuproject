            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-4">
                    <div class="form-group">
                      <label class="form-control-label" for="price">Harga 1:</label>
                  ...
                  <div class="col-4">
                    <div class="form-group">
                      <label class="form-control-label" for="price_2">Harga 2:</label>
                      <div class="input-group mb-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text">Rp</span>
                        </div>
                        <input type="text" name="price_2" value="<?php echo set_value('price_2'); ?>" class="form-control" id="price_2">
                      </div>
                  ...
                  <div class="col-4">
                    <div class="form-group">
                      <label class="form-control-label" for="price_3">Harga 3:</label>
                      <div class="input-group mb-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text">Rp</span>
                        </div>
                        <input type="text" name="price_3" value="<?php echo set_value('price_3'); ?>" class="form-control" id="price_3">
                      </div>
