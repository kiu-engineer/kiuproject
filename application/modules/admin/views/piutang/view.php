...
?>
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Data Piutang #<?php echo $payment->no_faktur; ?></h6>
            </div>
            <div class="col-lg-6 col-5 text-right">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item"><a href="#"><i class="fas fa-home"></i></a></li>
                  <li class="breadcrumb-item"><?php echo anchor('admin/piutang', 'Piutang'); ?></li>
                  <li class="breadcrumb-item active" aria-current="page">#<?php echo $payment->no_faktur; ?></li>
                </ol>
              </nav>
            </div>
          </div>
    ...
    <div class="container-fluid mt--6">
      <div class="row">
          ...
          <div class="card-wrapper">
            <div class="card">
              <div class="card-header">
                <h3 class="mb-0">No. Faktur <?php echo $payment->no_faktur; ?></h3>
                <?php if ($flash) : ?>
              ...
              <table class="table align-items-center table-flush table-hover">
                <tr>
                    <td>Nama</td>
                    <td><b><?php echo($payment->name); ?></b></td>
                </tr>
                <tr>
                    <td>Alamat</td>
                    <td><b><?php echo($payment->address); ?></b></td>
                </tr>
                <tr>
                    <td>Piutang</td>
                ...
                <tr>
                    <td>Terbayar</td>
                    <td><b>Rp <?php echo format_rupiah($payment->pay); ?></b></td>
                </tr>
                <tr>
                    <td>Sisa Piutang</td>
                    <td><b>Rp <?php echo format_rupiah($payment->piutang); ?></b></td>
                </tr>
                <tr>
        ...
        <div class="card card-primary">
            ...
            <div class="card-body p-0">
              <form action="<?php echo site_url('admin/piutang/verify'); ?>" method="POST">
                <table class="table align-items-center table-flush table-hover">
                  <input type="hidden" name="id" value="<?php echo $payment->id; ?>">
                    <tr>
                        <td>No. Faktur</td>
                        <td>
                            <input readonly type="text" value="<?php echo $payment->no_faktur; ?>" class="form-control form-control-sm" >
                        </td>
                    </tr>
                    <tr>
                        <td>Bayar</td>
                        <td>
                            <input type="text" placeholder="Rp. 0" class="form-control form-control-sm" name="pay">
                        </td>
                    </tr>
                    <tr>
                      <td></td>
  ...
  <!--      <div class="col-md-4">
            ...
            <!--  <div class="card-body p-0">
                <img alt="Pembayaran Order #<?php echo $payment->no_faktur; ?>" class="img img-fluid" src="<?php echo base_url('assets/uploads/payments/'. $payment->picture_name); ?>">
              </div> -->
