    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">No. Surat Jalan : <?php echo $customer->ttb_number; ?></h6>
        </div>
        <div class="col-lg-6 col-5 text-right">
          <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
              <li class="breadcrumb-item"><a href="#"><i class="fas fa-home"></i></a></li>
              <li class="breadcrumb-item"><?php echo anchor('admin/customers', 'Pengiriman'); ?></li>
              <!--    <li class="breadcrumb-item active" aria-current="page"><?php echo $customer->ttb_number; ?></li> -->
            </ol>
          </nav>
        </div>
      </div>
            ...
            <form action="<?php echo site_url('admin/customers/api/edit'); ?>" method="POST">
              <table class="table align-items-center table-flush table-hover">
                <tr>
                  ...
                  <td>
                    <input type="hidden" value="<?php echo $customer->ttb_number; ?>" name="user_id">
                    <input type="text" value="<?php echo $customer->ttb_number; ?>" class="form-control form-control-sm" name="name">
                  </td>
                </tr>
                <tr>
                <tr>
                  ...
                  <td>
                    <input type="text" value="<?php echo $customer->delivered_date; ?>" class="form-control form-control-sm" name="phone_number">
                  </td>
                </tr>
                <tr>
                  <td>No. Kendaraan</td>
                  <td>
                    <input type="text" value="<?php echo $customer->deliver_by; ?>" class="form-control form-control-sm" name="address">
                  </td>
                </tr>
              </table>
            </form>
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <?php foreach ($orders as $order) : ?>
                    ...
                    <?php $detail = json_decode($order->delivery_data); ?>
                    <tr>
                      <td>
                        <?php echo anchor('admin/orders/view/' . $order->id, '#' . $order->order_number); ?>
                      </td>
                      <td>
                        <?php echo $detail->customer->name; ?>
                      </td>
                      <td>
                        <?php echo $detail->customer->shop_address; ?>
                      </td>
                      <td>
