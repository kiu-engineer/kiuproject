        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Data Salesman</h6>
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="#" data-target="#addModal" data-toggle="modal" class="btn btn-sm btn-neutral">Tambah Sales</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush" id="salesmanTable" style="width: 100%">
                <thead class="thead-light">
                  <tr>
                    <th scope="col">#</th>
                    <th scope="col">Nama</th>
                    <th schope="col">Alamat</th>
                    <th schope="col">No Telp</th>
                    <th scope="col"></th>
                  </tr>
                </thead>
              </table>
          ...
          <div class="modal-body p-0">
              <div class="card bg-secondary border-0 mb-0">
                  <div class="card-header bg-transparent">
                      <h3 class="card-heading text-center mt-2">Tambah Salesman</h3>
                  </div>
                  <div class="card-body px-lg-5 py-lg-5">
                      <form role="form" action="#" method="POST" id="addSalesmanForm">
                          ...
                          <div class="form-group mb-3">
                              <div class="input-group input-group-merge input-group-alternative">
                                  ...
                                  <input name="name" class="form-control" autocomplete="off" placeholder="Nama salesman" type="text" maxlength="255" required>
                                </div>
                          ...
                          <div class="form-group mb-3">
                              <div class="input-group input-group-merge input-group-alternative">
                                  ...
                                  <input name="phone_number" class="form-control" autocomplete="off" placeholder="Nomor Telepon " type="text" maxlength="255" required>
                                </div>
                          ...
                          <div class="form-group mb-3">
                              <div class="input-group input-group-merge input-group-alternative">
                                  ...
                                  <input name="address" class="form-control" autocomplete="off" placeholder="Alamat" type="text" maxlength="255" required>
                                </div>
                                <div class="text-danger err code-error"></div>
                          </div>
  ...
  <div class="modal-dialog modal-modal-dialog-centered modal-" role="document">
      <div class="modal-content">
          <div class="modal-header">
              <h6 class="modal-title" id="modal-title-default">Hapus Salesman</h6>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">×</span>
              </button>
          </div>
          <form action="#" id="deleteSalesman" method="POST">
      ...
      <div class="modal-content">
          <div class="modal-body p-0">
              <div class="card bg-secondary border-0 mb-0">
                  ...
                  <div class="card-body px-lg-5 py-lg-5">
                      <form role="form" action="#" method="POST" id="editSalesmanForm">
                        ...
                        <div class="form-group mb-3">
                              <div class="input-group input-group-merge input-group-alternative">
                                  ...
                                  <input name="name" class="form-control edit-name" autocomplete="off" placeholder="Nama Salesman" type="text" maxlength="255" required>
                                </div>
                                <div class="text-danger err name-error"></div>
                          </div>
                          ...
                          <div class="form-group mb-3">
                              <div class="input-group input-group-merge input-group-alternative">
                                  ...
                                  <input name="phone_number" class="form-control edit-phone_number" autocomplete="off" placeholder="Nomor Telepon" type="text" maxlength="255" required>
                                </div>
                                <div class="text-danger err code-error"></div>
                          </div>
                          ...
                          <div class="form-group mb-3">
                              <div class="input-group input-group-merge input-group-alternative">
                                  ...
                                  <input name="address" class="form-control edit-address" autocomplete="off" placeholder="Nomor Telepon" type="text" maxlength="255" required>
                                </div>
                                <div class="text-danger err code-error"></div>
                          </div>
...
<script>
  $(document).ready(function() {
    ...
    $(document).on('click', '.btnEdit', function() {
      ...
      $.ajax({
        method: 'GET',
        url: '<?php echo site_url('admin/salesman/salesman_api?action=view_data'); ?>',
        data: {id: id},
        success: function(res) {
          if (res.data) {
            ...
            $('.edit-phone_number').val(d.phone_number);
    ...
    $('#editSalesmanForm').submit(function(e) {
      e.preventDefault();
      ...
      $.ajax({
        method: 'POST',
        url: '<?php echo site_url('admin/salesman/salesman_api?action=edit_salesman'); ?>',
        data: data,
        success: function (res) {
          if (res.code == 201) {
    ...
    $('#deleteSalesman').submit(function(e) {
      e.preventDefault();
      ...
      $.ajax({
        method: 'POST',
        url: '<?php echo site_url('admin/salesman/salesman_api?action=delete_salesman'); ?>',
        data: {
            id: id
        },
        success: function (res) {
    ...
    var table = $('#salesmanTable').DataTable({
      "ajax" : "<?php echo site_url('admin/salesman/salesman_api?action=list'); ?>",
      "columns" : [
        {"data": "id"},
        {"data": "name"},
        {"data": "address"},
    ...
    $('#addSalesmanForm').submit(function(e) {
      e.preventDefault();
      ...
      $.ajax({
        method: 'POST',
        url: '<?php echo site_url('admin/salesman/salesman_api?action=add_salesman'); ?>',
        data: data,
        context: this,
        success: function(res) {
          if (res.data) {
            ...
            setTimeout(function() {
              $('#addSalesmanForm .form-control').val(null);
              btn.html('Tambah');
            }, 2000);
            setTimeout(() => {
              $('#addModal').modal('hide');
